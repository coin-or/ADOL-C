...
/* ADOL-C Patchlevel */
#define ADOLC_PATCHLEVEL 12

/* ADOL-C safe extern mode */
/* #undef ADOLC_SAFE_EXTERN */

/* ADOL-C Subversion */
#define ADOLC_SUBVERSION 1
...
#define PACKAGE_STRING "adolc 2.1.12-trunk"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "adolc"

/* Define to the version of this package. */
#define PACKAGE_VERSION "2.1.12-trunk"
