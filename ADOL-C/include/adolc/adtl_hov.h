...
inline void setNumDir(const size_t p) {
  ...
  if (refcounter::refcnt > 0) {
    fprintf(DIAG_OUT,
            "ADOL-C Warning: Traceless: Setting numDir will not change the "
            "number of\n directional derivative in existing adoubles and may "
            "lead to erroneous results\n or memory corruption\n Number of "
            "currently existing adoubles = %zu\n",
            refcounter::refcnt);
  }
#endif
  if (p < 1) {
...
inline void setMode(enum Mode newmode) {
  ...
  if (refcounter::refcnt > 0) {
    fprintf(DIAG_OUT,
            "ADOL-C Warning: Traceless: Setting mode will the change the mode "
            "of\n computation in previously computed variables and may lead to "
            "erroneous results\n or memory corruption\n Number of currently "
            "existing adoubles = %zu\n",
            refcounter::refcnt);
  }
#else
  fprintf(DIAG_OUT,
...
inline adouble::adouble(const double v, const double *adv)
    : val(v), adval(NULL) {
  if (do_adval()) {
    adval = new double[adouble::numDir];
    FOR_I_EQ_0_LT_NUMDIR
...
inline adouble adouble::operator+() const { return *this; }
...
inline adouble tan(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for tan have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble sqrt(const adouble &a) {
  ...
  if (likely(adouble::_do_adval() && adouble::_do_val())) {
    FOR_I_EQ_0_LT_NUMDIR
    if (a.val > 0)
      tmp.ADVAL_I = a.ADVAL_I / (tmp.val * 2);
...
inline adouble asin(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for asin have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble acos(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for acos have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble atan(const adouble &a) {
  ...
  if (likely(adouble::_do_adval() && adouble::_do_val())) {
    ...
    if (tmp2 != 0)
      FOR_I_EQ_0_LT_NUMDIR
    tmp.ADVAL_I = a.ADVAL_I * tmp2;
    else FOR_I_EQ_0_LT_NUMDIR tmp.ADVAL_I = 0.0;
  }
  if (do_hoval()) // ADTL_HOV
  {
    // TODO
    std::cout << "error: higher order derivatives for atan have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble atan2(const adouble &a, const adouble &b) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for atan2 have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble pow(const adouble &a, double v) {
  ...
  {
    if (a.val == 0.0) {
      // idea: if v==adouble::degree  (as in: the power of a is equal to order
      // of derivatives to be calculated)
      //         then the derivative is a factorial of adouble::degree
      //         tgamma(adouble::degree+1)
...
inline adouble pow(const adouble &a, const adouble &b) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for pow(adouble,adouble) "
...
inline adouble log10(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for log10 have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble tanh(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for tanh have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble asinh(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for asinh have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble acosh(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for acosh have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble atanh(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for atanh have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble ceil(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for ceil have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble floor(const adouble &a) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for floor have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble fmax(const adouble &a, const adouble &b) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for fmax have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble fmin(const adouble &a, const adouble &b) {
  ...
  {
    // TODO
    std::cout << "error: higher order derivatives for fmin have not been "
                 "implemented yet!!!"
              << std::endl;
    exit(1);
  }
...
inline adouble erf(const adouble &a) {
  ...
  if (likely(adouble::_do_adval() && adouble::_do_val())) {
    double tmp2 = 2.0 / ADOLC_MATH_NSP_ERF::sqrt(ADOLC_MATH_NSP::acos(-1.0)) *
