...
ADOLC_DLL_EXPORT char* populate_dpp(double ***const pointer, char *const memory,
                                    int n, int m);
ADOLC_DLL_EXPORT char* populate_dpp_nodata(double ***const pointer, char *const memory,
                                           int n);
ADOLC_DLL_EXPORT char* populate_dpp_with_contigdata(double ***const pointer, char *const memory,
                                                    int n, int m,
                                                    double *const data);
...
ADOLC_DLL_EXPORT char* populate_dppp_nodata(double ****const pointer, char *const memory,
                                            int n, int m);
ADOLC_DLL_EXPORT char* populate_dppp_with_contigdata(double ****const pointer, char *const memory,
                                                     int n, int m, int p,
                                                     double *const data);
