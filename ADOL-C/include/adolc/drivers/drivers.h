...
ADOLC_DLL_EXPORT int large_jacobian(short, int, int, int, double *, double *,
                                    double **);
ADOLC_DLL_EXPORT fint large_jacobian_(fint *, fint *, fint *, fint *, fdouble *,
                                      fdouble *, fdouble *);
...
ADOLC_DLL_EXPORT int jac_vec(short, int, int, const double *, const double *,
                             double *);
ADOLC_DLL_EXPORT fint jac_vec_(fint *, fint *, fint *, fdouble *, fdouble *,
                               fdouble *);
...
ADOLC_DLL_EXPORT int hess_vec(short, int, const double *, const double *,
                              double *);
ADOLC_DLL_EXPORT fint hess_vec_(fint *, fint *, fdouble *, fdouble *,
                                fdouble *);

/*--------------------------------------------------------------------------*/
/*                                                           hessian_matrix */
/* hess_mat(tag, n, q, x[n], V[n][q], W[n][q])                              */
ADOLC_DLL_EXPORT int hess_mat(short, int, int, const double *,
                              const double *const *, double **);
ADOLC_DLL_EXPORT fint hess_mat_(fint *, fint *, fint *, fdouble *, fdouble **,
                                fdouble **);
...
ADOLC_DLL_EXPORT fint lagra_hess_vec_(fint *, fint *, fint *, fdouble *,
