...
public:
  ...
  CUDADEV friend adouble operator+(const double v, const adouble &a);
...
CUDADEV adouble adouble::operator+() const { return *this; }
...
CUDADEV void adouble::operator+=(const double v) { val += v; }
...
// not
CUDADEV int adouble::operator!() const { return val == 0.0; }

// comparison
CUDADEV int adouble::operator!=(const adouble &a) const { return val != a.val; }

CUDADEV int adouble::operator!=(const double v) const { return val != v; }

CUDADEV int operator!=(const double v, const adouble &a) { return v != a.val; }
...
/*******************  getter / setter  **************************************/
CUDAHOSTDEV double adouble::getValue() const { return val; }

CUDAHOSTDEV void adouble::setValue(const double v) { val = v; }

CUDAHOSTDEV ADVAL_TYPE adouble::getADValue() const { return (ADVAL_TYPE)adval; }
