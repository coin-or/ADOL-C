...
ADOLC_DLL_EXPORT int jac_pat(short, int, int, const double *, unsigned int **,
                             int *);
...
/*         crs[] [ crs[][0] = non-zero independent blocks per row ])        */
/*                                                                          */
ADOLC_DLL_EXPORT int absnormal_jac_pat(short, int, int, int, const double *,
                                       unsigned int **);
/*--------------------------------------------------------------------------*/
/*                                         seed matrix for sparse jacobian  */
/* generate_seed_jac(m, n, crs, &seed, &p, option);                         */

ADOLC_DLL_EXPORT void generate_seed_jac(int, int, unsigned int **, double ***,
                                        int *, int);
...
ADOLC_DLL_EXPORT int sparse_jac(short, int, int, int, const double *, int *,
...
ADOLC_DLL_EXPORT void generate_seed_hess(int, unsigned int **, double ***,
                                         int *, int);
...
ADOLC_DLL_EXPORT int sparse_hess(short, int, int, const double *, int *,
                                 unsigned int **, unsigned int **, double **,
                                 int *);

ADOLC_DLL_EXPORT void set_HP(short tag, /* tape identification */
                             int indep, /* number of independent variables */
                             unsigned int **HP);

ADOLC_DLL_EXPORT void get_HP(short tag, /* tape identification */
                             int indep, /* number of independent variables */
                             unsigned int ***HP);
