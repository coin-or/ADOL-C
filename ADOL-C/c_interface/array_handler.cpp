...
extern "C"
{
    ...
    const double getindex_tens(const double ***A, const int dim, const int row, const int col)
    {
        return A[dim][row][col];
    }
    void setindex_tens(double ***A, const double val, const int dim, const int row, const int col)
    {
        A[dim][row][col] = val;
    }
