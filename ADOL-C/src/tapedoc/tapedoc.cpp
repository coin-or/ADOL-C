...
static constexpr std::string_view baseName{"tape_"};
static constexpr std::string_view extension{".tex"};
...
void filewrite_start(int opcode) {
  ...
  fprintf(fp, " & & code & op & loc & loc & loc & loc & double & double & "
...
/****************************************************************************/
void filewrite(unsigned short opcode, const char *opString, int nloc,
               size_t *loc, int ncst, double *cst) {
  int i;

  checkPageBreak();

  /* write opcode counters and  number */
  fprintf(fp, "%i & %zu & %i & ", op_cnt, rev_op_cnt, opcode);
...
/****************************************************************************/
void filewrite_ampi(unsigned short opcode, const char *opString, int nloc,
                    int *loc) {
  int i;
...
#ifdef ADOLC_TAPE_DOC_VALUES
  fprintf(fp,
          " %i & %i & %i & end of tape & & & & & & & & & &  \\\\ \\hline \n",
          op_cnt, rev_op_cnt, opcode);
#else
  fprintf(fp, " %i & %zu & %i & end of tape & & & & & & \\\\ \\hline \n",
          op_cnt, rev_op_cnt, opcode);
#endif
  fprintf(fp, "\\end{tabular}");
              ...
              double *)       /* dependent variable values */
{
  ...
  while (operation != end_of_tape) {
    ...
    case lt_zero: /* lt_zero */
      ...
      val_a[0] = dp_T0[arg];
#endif
      filewrite(operation, "lt zero", 1, loc_a, 0, cst_d);
      break;
    ...
    case assign_a: /* assign an adouble variable an    assign_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "assign a", 2, loc_a, 0, cst_d);
      break;
    ...
    case assign_d: /* assign an adouble variable a    assign_d */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "assigne d", 1, loc_a, 1, cst_d);
      break;
    ...
    case assign_d_one: /* assign an adouble variable a    assign_d_one */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "assign d one", 1, loc_a, 0, cst_d);
      break;
    ...
    case assign_d_zero: /* assign an adouble variable a    assign_d_zero */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "assign d zero", 1, loc_a, 0, cst_d);
      break;
    ...
    case assign_ind: /* assign an adouble variable an    assign_ind */
      ...
      val_a[0] = dp_T0[res];
      filewrite(operation, "assign ind", 1, loc_a, 1, cst_d);
#else
      filewrite(operation, "assign ind", 1, loc_a, 0, cst_d);
#endif
...
#endif
      filewrite(operation, "assign dep", 1, loc_a, 0, cst_d);
      break;
    ...
    case eq_plus_d: /* Add a floating point to an    eq_plus_d */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "eq plus d", 1, loc_a, 1, cst_d);
      break;
    ...
    case eq_plus_a: /* Add an adouble to another    eq_plus_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "eq plus a", 2, loc_a, 0, cst_d);
      break;
    ...
    case eq_plus_prod: /* Add an product to an            eq_plus_prod */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "eq plus prod", 3, loc_a, 0, cst_d);
      break;
    ...
    case eq_min_d: /* Subtract a floating point from an    eq_min_d */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "eq min d", 1, loc_a, 1, cst_d);
      break;
    ...
    case eq_min_a: /* Subtract an adouble from another    eq_min_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "eq min a", 2, loc_a, 0, cst_d);
      break;
    ...
    case eq_min_prod: /* Subtract an product from an      eq_min_prod */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "eq min prod", 3, loc_a, 0, cst_d);
      break;
    ...
    case eq_mult_d: /* Multiply an adouble by a    eq_mult_d */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "eq mult d", 1, loc_a, 1, cst_d);
      break;
    ...
    case eq_mult_a: /* Multiply one adouble by another    eq_mult_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "eq mult a", 2, loc_a, 0, cst_d);
      break;
    ...
    case incr_a: /* Increment an adouble    incr_a */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "incr a", 1, loc_a, 0, cst_d);
      break;
    ...
    case decr_a: /* Increment an adouble    decr_a */
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "decr a", 1, loc_a, 0, cst_d);
      break;
    ...
    case plus_a_a: /* : Add two adoubles. (+)    plus a_a */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "plus a a", 3, loc_a, 0, cst_d);
      break;
    ...
    case plus_d_a: /* Add an adouble and a double    plus_d_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "plus d a", 2, loc_a, 1, cst_d);
      break;
    ...
    case min_a_a: /* Subtraction of two adoubles     min_a_a */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "min a a", 3, loc_a, 0, cst_d);
      break;
    ...
    case min_d_a: /* Subtract an adouble from a    min_d_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "min d a", 2, loc_a, 1, cst_d);
      break;
    ...
    case mult_a_a: /* Multiply two adoubles (*)    mult_a_a */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "mult a a", 3, loc_a, 0, cst_d);
      break;
    ...
    case mult_d_a: /* Multiply an adouble by a double    mult_d_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "mult d a", 2, loc_a, 1, cst_d);
      break;
    ...
    case div_a_a: /* Divide an adouble by an adouble    div_a_a */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "div a a", 3, loc_a, 0, cst_d);
      break;
    ...
    case div_d_a: /* Division double - adouble (/)    div_d_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "div d a", 2, loc_a, 1, cst_d);
      break;
    ...
    case pos_sign_a: /* pos_sign_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "pos sign a", 2, loc_a, 0, cst_d);
      break;
    ...
    case neg_sign_a: /* neg_sign_a */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "neg sign a", 2, loc_a, 0, cst_d);
      break;
    ...
    case exp_op: /* exponent operation    exp_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "exp op", 2, loc_a, 0, cst_d);
      break;
    ...
    case sin_op: /* sine operation    sin_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "sin op", 3, loc_a, 0, cst_d);
      break;
    ...
    case cos_op: /* cosine operation    cos_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "cos op", 3, loc_a, 0, cst_d);
      break;
    ...
    case atan_op: /* atan_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "atan op", 3, loc_a, 0, cst_d);
      break;
    ...
    case asin_op: /* asin_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "asin op", 3, loc_a, 0, cst_d);
      break;
    ...
    case acos_op: /* acos_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "acos op", 3, loc_a, 0, cst_d);
      break;
    ...
    case asinh_op: /* asinh_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "asinh op", 3, loc_a, 0, cst_d);
      break;
    ...
    case acosh_op: /* acosh_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "acosh op", 3, loc_a, 0, cst_d);
      break;
    ...
    case atanh_op: /* atanh_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "atanh op", 3, loc_a, 0, cst_d);
      break;
    ...
    case erf_op: /* erf_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "erf op", 3, loc_a, 0, cst_d);
      break;
    ...
    case erfc_op: /* erfc_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "erfc op", 3, loc_a, 0, cst_d);
      break;
    ...
    case log_op: /* log_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "log op", 2, loc_a, 0, cst_d);
      break;
    ...
    case pow_op: /* pow_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "pow op", 2, loc_a, 1, cst_d);
      break;
    ...
    case sqrt_op: /* sqrt_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "sqrt op", 2, loc_a, 0, cst_d);
      break;
    ...
    case cbrt_op: /* cbrt_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "cbrt op", 2, loc_a, 0, cst_d);
      break;
    ...
    case gen_quad: /* gen_quad */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "gen quad", 3, loc_a, 2, cst_d);
      break;
    ...
    case min_op: /* min_op */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "min op", 3, loc_a, 1, cst_d);
      break;
    ...
    case abs_val: /* abs_val */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "abs val", 2, loc_a, 1, cst_d);
      break;
    ...
    case ceil_op: /* ceil_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "ceil op", 2, loc_a, 1, cst_d);
      break;
    ...
    case floor_op: /* Compute ceil of adouble    floor_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "floor op", 2, loc_a, 1, cst_d);
      break;
    ...
    case cond_assign: /* cond_assign */
      ...
      val_a[3] = dp_T0[res];
#endif
      filewrite(operation, "cond assign $\\longrightarrow$", 4, loc_a, 1,
                cst_d);
      break;
    ...
    case cond_assign_s: /* cond_assign_s */
      ...
      val_a[2] = dp_T0[res];
#endif
      filewrite(operation, "cond assign s $\\longrightarrow$", 3, loc_a, 1,
                cst_d);
      break;
...
#endif
      filewrite(operation, "vec copy $\\longrightarrow$", 3, loc_a, 0, cst_d);
      break;
    ...
    case vec_dot:
      ...
      val_a[0] = dp_T0[res];
#endif
      filewrite(operation, "vec dot $\\longrightarrow$", 4, loc_a, 0, cst_d);
      break;
...
#endif
      filewrite(operation, "vec axpy $\\longrightarrow$", 4, loc_a, 0, cst_d);
      break;
    ...
    case take_stock_op: /* take_stock_op */
      ...
      val_a[1] = dp_T0[res];
#endif
      filewrite(operation, "take stock op", 2, loc_a, 1, cst_d);
      break;
