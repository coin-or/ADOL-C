             ...
             short **nonzero) /* optional sparsity characterization  */
{
  /*
      ...
      (i,j) the entries A[i][j][k=0...] are nonzero either for all k, or for no
     k, or for k=0 only. On entry the optional short array nonzero may be used
     to identify all entries of the A[.][.][k] that are potentially nonzero,
     i.e.
