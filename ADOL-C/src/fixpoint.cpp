...
static int fp_fos_forward(int dim_xu, double *xu, double *xu_dot, int dim_x,
                          double *x_fix, double *x_fix_dot) {
  // Piggy back
  int i, k;
...
static int fp_hos_reverse(int dim_x, double *x_fix_bar, int dim_xu,
...
static int fp_fos_reverse(int dim_x, double *x_fix_bar, int dim_xu,
                          double *xu_bar, double * /*unused*/,
                          double * /*unused*/) {
  // (d x_fix) / (d x_0) = 0 (!)
  int i, k;
