% Latex file containing the documentation of ADOL-C version 2.1.6
%
...
\vspace{.2in}
{\large\bf  Version 2.1.6, July 2010} \\
\bigskip
...
\verb=</SOMEPATH/ADOL-C-2.1.6>= will compile the static and the dynamic
...
%Then it is assumed that the ColPack library
%available at
...
directories \verb=<ADOL-C-2.1.6>/ADOL-C/examples= and the
additional examples in
\verb=<ADOL-C-2.1.6>/ADOL-C/examples/additional_examples=. However,
...
\verb=<ADOL-C-2.1.6>/ADOL-C/examples= of ADOL-C. In particular,
