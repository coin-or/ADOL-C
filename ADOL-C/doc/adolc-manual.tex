...
%
To use the tapeless forward mode, one has to include only
the header file \verb#adtl.h# since it does not include the
tape based functions defined in other header files. 
...
\begin{center}
  \begin{tabular}{l}
    {\sf g++ -o tapeless\_scalar tapeless\_scalar.o -ladolc -L/home/username/adolc\_base/lib}
  \end{tabular}
\end{center}
