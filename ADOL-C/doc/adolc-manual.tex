...
header \verb=<adolc/ad_types.h>=. The latter must be included for compilation
...
\verb=<adolc/ad_types.h>= automatically.
...
{\sf adouble}s and with the header file \verb=<adolc/ad_types.h>= included.  
...
header file \verb=<adolc/ad_types.h>= included as described
...
The header file \verb=<adolc/ad_types.h>=
...
\item 
Compile the codes after including the header file \verb=<adolc/ad_types.h>=. 
\end{enumerate}
...
%                   (see \autoref{arrays}); \\
%  $\bullet$     & is included by the header \verb=<adolc/ad_types.h>=.
%\end{tabular*}
%\\ \hline
...
{\sf ADOLC\_DLL\_EXPORT adouble} in \verb=<adolc/ad_types.h>=, add the statement
\begin{center}
...
\begin{verbatim}
#include <adolc/ad_types.h>               // use of active doubles and taping
