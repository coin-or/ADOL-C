/*----------------------------------------------------------------------------
 ...
 File:     traceless_scalar.cpp
 Revision: $Id$
 Contents: computation of coordinate transform,
           scalar traceless forward mode
...
int main(int argc, char *argv[]) {
  ...
  cout << endl
       << "Compute transform from Cartesian to spherical polar coordinates"
       << endl
       << endl;
  ...
  cout << "dy[0]/dx[0] = " << *y[0].getADValue()
       << "  dy[1]/dx[0] = " << *y[1].getADValue()
