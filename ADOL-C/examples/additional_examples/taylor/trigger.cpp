...
int main() {
  ...
  Fh[0] = x[0] / 20 -
          1e-9 * (exp(30 * (x[4] - x[0])) + exp(30 * (x[2] - x[0]))) - 1.88e-7;
  Fh[0] += +.95e-7 * (exp(30 * (x[4] - x[1])) + exp(30 * (x[2] - x[3])));
  Fh[1] = .99e-9 * exp(30 * (x[4] - x[0])) - 1e-7 * exp(30 * (x[4] - x[1])) +
          .9901e-7;
  Fh[1] += +(x[1] - x[2]) / 50 - (6 - x[1]) / x[5] - x[6];
  Fh[2] = 1e-11 * exp(30 * (x[2] - x[0])) + 5e-9 * exp(30 * (x[2] - x[3])) -
          5.01e-9;
  Fh[2] += -(x[1] - x[2]) / 50;
  Fh[3] = .99e-9 * exp(30 * (x[2] - x[0])) - 1e-7 * exp(30 * (x[2] - x[3])) +
          .9901e-7;
  Fh[3] += -(6 - x[3]) / 5;
