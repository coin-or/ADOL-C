...
public:
  ...
  virtual int fos_forward(int n, double *yin, double *yindot, int m,
                          double *yout, double *youtdot) {
    int rc;
    set_nested_ctx(tag_ext_fct, true);
  ...
  virtual int fov_forward(int n, double *yin, int p, double **yindot, int m,
                          double *yout, double **youtdot) {
    int rc;
    set_nested_ctx(tag_ext_fct, true);
  ...
  virtual int fos_reverse(int n, double *u, int m, double *z,
  ...
  virtual int fov_reverse(int n, int p, double **U, int m, double **Z,
                          double * /* unused */, double * /*unused*/) {
    int rc;
    set_nested_ctx(tag_ext_fct, true);
    ::zos_forward(tag_ext_fct, 2, 2, 1, edf->dp_x, edf->dp_y);
