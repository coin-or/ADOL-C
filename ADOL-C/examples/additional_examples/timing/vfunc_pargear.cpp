...
void gearFunction(
    ...
    int radialMotionDegree, double *radialMotionCoeff, int verticalMotionDegree,
    double *verticalMotionCoeff, int horizontalMotionDegree,
    double *horizontalMotionCoeff, int helicalMotionDegree,
    double *helicalMotionCoeff, int angularMotionDegree,
    double *angularMotionCoeff, int modifiedRollDegree,
...
void originalVectorFunction(double *indeps, double *deps) {
  ...
  gearFunction(indeps, deps,
               ...
               zs, // Sphaerik-Mitte-Z
               // jetzt die Zusatzbewegungen
               radMotDegree, radMotCoeff, verMotDegree, verMotCoeff,
               horMotDegree, horMotCoeff, helMotDegree, helMotCoeff,
               angMotDegree, angMotCoeff, modRolDegree, modRolCoeff);
}
...
void activeGearFunction(
    ...
    double hgZs, // Sphaerik-Mitte-Z
    // jetzt die Zusatzbewegungen
    int radialMotionDegree, adouble *radialMotionCoeff,
    int verticalMotionDegree, adouble *verticalMotionCoeff,
    int horizontalMotionDegree, adouble *horizontalMotionCoeff,
    int helicalMotionDegree, adouble *helicalMotionCoeff,
    int angularMotionDegree, adouble *angularMotionCoeff,
    int modifiedRollDegree, adouble *modifiedRollCoeff) {
  int i;
  adouble ah;
...
void tapingVectorFunction(int tag, double *indeps, double *deps) {
  ...
  activeGearFunction(activeIndeps, activeDeps,
                     ...
                     zs, // Sphaerik-Mitte-Z
                     // jetzt die Zusatzbewegungen
                     radMotDegree, activeRadMotCoeff, verMotDegree,
                     activeVerMotCoeff, horMotDegree, activeHorMotCoeff,
                     helMotDegree, activeHelMotCoeff, angMotDegree,
                     activeAngMotCoeff, modRolDegree, activeModRolCoeff);
