...
int main() {
  ...
  if ((pTR < 1) && (controlParameters[cpTensor])) {
  ...
  if (controlParameters[cpFovFW]) {
    fprintf(stdout, "--------------------------------------------------------");
    fprintf(stdout,
            "\nTASK %d: forward(tag, m=1, n=%d, p=%d, x[n], X[n][p], y[m], "
            "Y[m][p])\n",
  ...
  if (controlParameters[cpHovFW]) {
    fprintf(stdout, "--------------------------------------------------------");
    fprintf(stdout,
            "\nTASK %d: forward(tag, m=1, n=%d, d=%d, p=%d, x[n], X[n][p][d], "
            "y[m], Y[m][p][d])\n",
  ...
  if (controlParameters[cpHovRV]) {
    fprintf(stdout, "--------------------------------------------------------");
    fprintf(stdout,
            "\nTASK %d: reverse(tag, m=1, n=%d, d=%d, p=%d, U[p], "
            "Z[p][n][d+1], nz[p][n])\n",
  ...
  if (controlParameters[cpTensor]) {
    fprintf(stdout, "--------------------------------------------------------");
    fprintf(stdout,
            "\nTASK %d: tensor_eval(tag, m =1, n=%d, d=%d, p=%d, X[n], "
            "tensor[m][dim], S[n][p])\n",
  ...
  if (controlParameters[cpInvTensor] && (1 == indepDim)) {
    fprintf(stdout, "--------------------------------------------------------");
    fprintf(stdout,
            "\nTASK %d: inverse_tensor_eval(tag, m=n=1, d=%d, p=%d, X[n], "
            "tensor[m][dim], S[n][p])\n",
